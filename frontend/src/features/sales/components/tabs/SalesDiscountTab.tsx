...
export function SalesDiscountTab() {
  const [items, setItems] = useState<any[]>([{
    id: "1", productCode: "SP001", productName: "Sản phẩm A", discountAccount: "5111", debtAccount: "131", unit: "Cái", quantity: 1, unitPrice: 50000, amount: 50000, vatRate: 10, vatAmount: 5000, vatAccount: "33311", originalVoucherNo: "BH02976"
  }]);

  const columns: Column<any>[] = [
    { key: "productCode", header: "Mã hàng", type: "text", width: "120px" },
    { key: "productName", header: "Tên hàng", type: "text" },
    { key: "discountAccount", header: "TK Giảm giá", type: "text", width: "100px" },
    ...
    { key: "vatAccount", header: "TK Thuế GTGT", type: "text", width: "100px" },
    { key: "originalVoucherNo", header: "Số CT bán hàng", type: "text", width: "120px" },
  ];
    ...
    <div className="flex flex-col h-full bg-slate-50">
      <div className="bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between sticky top-0 z-10 shadow-sm">
        <h2 className="text-lg font-bold text-slate-800 flex items-center gap-4">
          Chứng từ giảm giá hàng bán BGG00002
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-4">
          <div className="flex items-center gap-6 mb-4 pb-4 border-b border-slate-100">
            <label className="flex items-center gap-2 text-sm font-medium"><input type="radio" defaultChecked name="discountType" className="text-emerald-600 focus:ring-emerald-500" /> Giảm trừ công nợ</label>
            <label className="flex items-center gap-2 text-sm font-medium"><input type="radio" name="discountType" className="text-emerald-600 focus:ring-emerald-500" /> Trả lại tiền mặt</label>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="col-span-3 grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 border border-slate-300 rounded-md text-sm" defaultValue="Giảm giá hàng bán" />
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                  ...
                  <input type="text" className="text-sm bg-transparent font-bold text-slate-800 outline-none text-right w-24" defaultValue="BGG00002" />
                </div>
              </div>
              <div className="mt-4 text-right">
                <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Tổng tiền giảm giá</p>
          ...
          <div className="bg-slate-50 border-t border-slate-200 p-4 flex justify-between items-start">
            ...
            <div className="w-64 space-y-2 text-sm">
              ...
              <div className="flex justify-between pt-2 border-t border-slate-200">
                <span className="font-bold text-slate-800">Tổng tiền giảm</span>
