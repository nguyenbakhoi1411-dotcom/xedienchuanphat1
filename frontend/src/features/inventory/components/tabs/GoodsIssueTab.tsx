...
export function GoodsIssueTab() {
  const [items, setItems] = useState<any[]>([{
    id: "1", productCode: "SP001", productName: "Sản phẩm A", warehouse: "Kho thành phẩm", debitAccount: "632", creditAccount: "1561", unit: "Cái", quantity: 1, unitPrice: 0, amount: 0
  }]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="col-span-3 grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 border border-slate-300 rounded-md text-sm outline-none focus:border-emerald-500" placeholder="Chọn khách hàng..." />
              </div>
              <div>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-500 mb-1">Người nhận</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-500 mb-1">Lý do xuất</label>
                <input type="text" className="w-full px-3 py-2 border border-slate-300 rounded-md text-sm" defaultValue="xuất kho bán hàng" />
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 flex flex-col justify-between">
              <div className="space-y-3">
                <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                  ...
                  <input type="datetime-local" className="text-sm bg-transparent font-medium text-slate-800 outline-none text-right" defaultValue="2026-06-20T23:40:11" />
                </div>
                <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                ...
                <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                  ...
                  <input type="text" className="text-sm bg-transparent font-bold text-slate-800 outline-none text-right w-24" defaultValue="XK02977" />
                </div>
              </div>
