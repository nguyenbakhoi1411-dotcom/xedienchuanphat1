...
@Component
public class GeneralLedgerReportGenerator implements ReportGenerator {
    private final JdbcTemplate jdbcTemplate;

    public GeneralLedgerReportGenerator(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    @Override
    public boolean supports(String reportType) {
        return "kt-so-cai".equals(reportType);
    }
