...
public interface GoodsIssueRepository extends JpaRepository<GoodsIssue, Long> {
    ...
    Page<GoodsIssue> findByWarehouse_IdIn(List<Long> warehouseIds, Pageable pageable);

    Page<GoodsIssue> findByWarehouse_IdInAndStatus(List<Long> warehouseIds, String status, Pageable pageable);

    Page<GoodsIssue> findByWarehouse_IdInAndIssueType(List<Long> warehouseIds, GoodsIssueType issueType, Pageable pageable);
